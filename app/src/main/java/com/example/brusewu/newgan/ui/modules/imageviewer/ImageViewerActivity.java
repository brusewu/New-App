package com.example.brusewu.newgan.ui.modules.imageviewer;
...
import com.example.brusewu.newgan.ui.adapter.ImageViewPagerAdapter;
...
public class ImageViewerActivity extends BaseActivity implements ImageViewerContract.View {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState){
        ...
        imageViewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            @Override
            public void onPageScrollStateChanged(int sate) {
